 ...
 * 未使用的优惠券
 */
public class NotUsedFragment extends BaseFragment<NotUsedPresenter> {
    ...
    protected int setupView() {
        return R.layout.fragment_not_used;
    }
    ...
    @Override
    protected NotUsedPresenter bindPresenter() {
        return new NotUsedPresenter();
    }
    ...
    private void initRecyclerView() {
        ...
        adapter = new NotUsedAdapter(R.layout.item_not_used);
