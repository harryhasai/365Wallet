 ...
 */
public class NearbyShopListAdapter extends BaseQuickAdapter<NearbyShopListEntity.DataBean.ListBean, BaseViewHolder> {

    public NearbyShopListAdapter(int layoutResId) {
        super(layoutResId);
    }
