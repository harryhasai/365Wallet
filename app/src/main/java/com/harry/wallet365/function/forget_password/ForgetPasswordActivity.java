...
public class ForgetPasswordActivity extends BaseActivity<ForgetPasswordPresenter> {
    ...
    protected ArrayList<Object> cancelNetWork() {
        ...
        tags.add(DisposableFinal.FORGET_PASSWORD_ACTIVITY_FORGET_PASSWORD);
        tags.add(DisposableFinal.FORGET_PASSWORD_ACTIVITY_GET_VERIFICATION_CODE);
        return tags;
    }
    ...
    private void confirm() {
        ...
        mPresenter.forgetPassword(phone, password, verificationCode);
    }
