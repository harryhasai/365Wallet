...
public interface AddressService {
    ...
    @FormUrlEncoded
    @POST
    Observable<AddressEntity> getAddress(@Url String url, @FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST
    Observable<CommonEntity> deleteAddress(@Url String url, @FieldMap Map<String, String> params);
}
